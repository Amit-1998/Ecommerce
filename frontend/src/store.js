...
// when we refresh the web page so the states in store gets empty so for that we are using localStorage to store states there as well
let initialState = {
    cart: {
...
const middleware = [thunk]; // Add all your middleware in an array
