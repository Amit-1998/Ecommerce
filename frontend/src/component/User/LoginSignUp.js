...
const LoginSignUp = ({ location }) => {
    const dispatch = useDispatch(); // ye hame useEffect mein nhi karna balki form submit karte vakt karna hai
    ...
    const loginSubmit = (e) => {
        ...
        dispatch(login(loginEmail, loginPassword)); // call the function
    }
    ...
    const registerSubmit = (e) => {
        ...
        dispatch(register(myForm)); // form submit karne par dispatch kar dia yani register function calll kar dia
    }
    ...
    // redirect to shipping => "/login?redirect=shipping"
